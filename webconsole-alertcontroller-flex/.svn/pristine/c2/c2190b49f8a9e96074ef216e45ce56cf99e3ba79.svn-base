...
{
	import com.deleidos.rtws.alertcontroller.events.HTTPQueueEvent;
	import com.deleidos.rtws.alertcontroller.models.ParameterModel;
	import com.deleidos.rtws.alertcontroller.services.rest.SimpleRestService;
	import com.deleidos.rtws.alertcontroller.utils.HttpUtilities;
	...
	public class RepositoryRestService extends SimpleRestService implements IResponder
	{
		...
		private function makeAccessString():String {
			return "?userId=" + encodeURIComponent(ServiceConstants.getUserId(appParams.tenantName)) + "&password=" + encodeURIComponent(ServiceConstants.getUserId(appParams.tenantName));
		}
		...
		public function sendListContentRequest(rp:Object, visibility:String, path:String):void {
			var url:String = 
				appParams.selfPrefixUrl +
				CONTEXT_PATH + "/list/" + 
				encodeURIComponent(ServiceConstants.getTenantPath(appParams.tenantName)) + "/" + 
