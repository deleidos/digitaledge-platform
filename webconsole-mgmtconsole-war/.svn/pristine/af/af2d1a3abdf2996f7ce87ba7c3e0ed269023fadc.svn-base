...
public final class RestClientManager {
	...
	private static LicenseValidatorClient LICENSE_VALIDATOR_CLIENT;
	...
	public static synchronized LicenseValidatorClient getLicenseValidatorClient() {
		
		if (LICENSE_VALIDATOR_CLIENT == null) {
			LICENSE_VALIDATOR_CLIENT = new LicenseValidatorClient();
		}
		
		return LICENSE_VALIDATOR_CLIENT;
