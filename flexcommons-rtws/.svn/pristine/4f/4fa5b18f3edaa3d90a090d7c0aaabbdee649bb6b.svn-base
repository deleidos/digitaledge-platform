 ...
 */
package com.deleidos.rtws.commons.model.datamodel
{
	...
	public class DataModelZipFile
	{
		...
		public static var TEXT_TYPE:String = ".txt";
		...
		public function getCustomConfig(parserName:String, inputFormatName:String):String {
			var filename:String = parserName.toLowerCase() + "_" + inputFormatName + TEXT_TYPE;
			var data:ByteArray = getContents(filename);
			return (data == null) ? (null) : data.toString();
		}
			
		public function putCustomConfig(parserName:String, inputFormatName:String, configText:String):void {
			var filename:String = parserName.toLowerCase() + "_" + inputFormatName + TEXT_TYPE;
			putStringEntry(filename, configText);
		}
