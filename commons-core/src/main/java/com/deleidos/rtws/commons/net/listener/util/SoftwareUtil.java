 ...
 */
package com.deleidos.rtws.commons.net.listener.util;
...
public final class SoftwareUtil {
	...
	public static final String INGEST_CONF_FILE = "/deleidos-rtws-ingest-conf.tar.gz";
	public static final String INGEST_BIN_DIR = "/usr/local/rtws/ingest/bin";
	public static final String INGEST_LOGS_DIR = "/usr/local/rtws/ingest/logs";
	...
	public static final String INGEST_INACTIVE_LOGS_FILENAME = ".ingest_inactive";
	...
	public static final String TRANSPORT_LOGS_DIR = "/usr/local/rtws/transport/logs";
	public static final String TRANSPORT_CONF_DIR = "/usr/local/rtws/transport/conf";
	public static final String TRANSPORT_CONFIG_FILENAME = "transports.default.xml";
	public static final String TRANSPORT_CONF_FILE = "/deleidos-rtws-transport-conf.tar.gz";
	...
	public static final String TRANSPORT_INACTIVE_LOGS_FILENAME = ".transport_inactive";
	...
	private static int DEFAULT_INACTIVE_FILES_COUNT = 1;
	...
	public static boolean isInactive(String location, String completeName, int numFilesExpected) {
		return checkDirectory(location, completeName, numFilesExpected);
	}
	
	public static boolean isInactive(String location, String completeName) {
		return checkDirectory(location, completeName, DEFAULT_INACTIVE_FILES_COUNT);
	}
	
	private static boolean checkDirectory(String location, String completeName, int numFilesExpected) {
		
		File folder = new File(location);
		File[] files = folder.listFiles();
		int numCompleteFilesFound = 0;
		
		for (File file : files) {
			if (file.getName().contains(completeName)) {
				numCompleteFilesFound++;
			}
		}
		
		// if max number of processes are found, then it is inactive
		if (numCompleteFilesFound == numFilesExpected) {
			return true;
		}
