...
def removeOldLucene():
	print 'Removing outdated Lucene core'
	os.remove('/usr/local/rtws/ingest/lib/lucene-core-2.9.3.jar')
...
def autoRemove():
    print 'Performing auto removal to remove applicable packages.'
...
def run():
    ...
    is_tms = os.environ.get('RTWS_IS_TMS','False')
    ...
    if 'master.ini' in manifest.strip():
        ...
        removePentaho()
        removeActiveMQ()
    elif 'single-instance.ini' in manifest.strip():
        removeAllHadoopComponents()
        removePentaho()
        removeActiveMQ()
    
    elif processGroup.strip() == 'ingest.all' or processGroup.strip() == 'mongodb.replicated' or processGroup.strip() == 'datasink.mongodb' or processGroup.strip() == 'datasink.mongodb.replicated':
        removeAllHadoopComponents()
        removePentaho()
        removeActiveMQ()
        
    elif processGroup.strip() == 'datasink.elasticsearchdatasink':
    	removeOldLucene()
