...
package com.deleidos.rtws.tc.views.popups
{
	...
	{
		[Inject] public var view:NotificationView;
		...
		public override function onRegister():void {
			...
			if (view.reason == null) {
				view.currentState = view.noReason.name;
			} else {
				view.currentState = view.withReason.name;
				view.reasonTextArea.text = view.reason;
			}
		}
		...
		protected function handleOkButton(event:MouseEvent):void {
			if (view.onExitEvent != null) {
				dispatch(view.onExitEvent);	
			}
