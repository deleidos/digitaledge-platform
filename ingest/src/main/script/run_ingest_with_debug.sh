...
java -Xdebug -Xnoagent -Xrunjdwp:transport=dt_socket,address=8080,server=y,suspend=n -Xmx${jvmsize}m -Dlog4j.configuration=file:///usr/local/rtws/ingest/conf/log4j.properties $RTWS_INGEST_OPTIONS -cp $CLASSPATH_MOD -Djava.library.path=../lib/native com.deleidos.rtws.core.framework.IngestManager ../conf/$RTWS_INGEST_CONFIG