...
package com.deleidos.rtws.systemcfg.services
{
	...
	public class PollingService extends Actor
	{
		...
		protected function timerEventHandler(event:TimerEvent):void {
			...
			for (var i:int=0; i<_services.length; i++) {
				var service:IWebPollable = _services[i] as IWebPollable;
				service.poll(now, 0);
			}
		}
		
		public function register(service:IWebPollable):void {
		...
		public function changePollingInterval(seconds:int):void {
			_timer.stop();
