...
public class MockEucaDescribeAvailabilityZones implements EucaDescribeCommand {

	@Override
	public String execute() {
		Reader input = null;
		try {
			input = new FileReader("./src/test/resources/euca-describe-availability-zones-verbose_sample_format.txt");
