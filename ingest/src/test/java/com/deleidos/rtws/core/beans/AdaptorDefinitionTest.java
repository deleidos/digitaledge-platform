...
public class AdaptorDefinitionTest {
	...
	public void testConstructor() {
		AdaptorDefinition obj1 = new AdaptorDefinition();
		assertNotNull(obj1);
	}
	...
	public void testGettersAndSetters() {
		...
		AdaptorDefinition beanObj = new AdaptorDefinition();
		...
		//// Test Class
		////beanTester.testClass(Filter.class);
