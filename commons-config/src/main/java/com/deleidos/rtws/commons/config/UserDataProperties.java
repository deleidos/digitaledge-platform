...
public class UserDataProperties {
	...
	public static final String RTWS_APP_LOG_LEVEL = "RTWS_APP_LOG_LEVEL";
	...
	public static final String RTWS_MAX_ALLOCATION_REQUEST = "RTWS_MAX_ALLOCATION_REQUEST";
	public static final String RTWS_TENANT_ACCESS_KEY = "RTWS_TENANT_ACCESS_KEY";
	public static final String RTWS_TENANT_SECRET_KEY = "RTWS_TENANT_SECRET_KEY";
	public static final String RTWS_TENANT_EMAIL = "RTWS_TENANT_EMAIL";
	...
	private UserDataProperties() {
		...
		try {
			...
			logger.info(String.format("Loading properties from: %s", userDataFileAbsPath));
