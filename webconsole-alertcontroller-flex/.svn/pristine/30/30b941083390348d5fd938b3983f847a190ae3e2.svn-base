...
{
	public class AlertCriteriaEntry
	{
		[Bindable]
		...
		public function AlertCriteriaEntry(alertDefKey:String, alertDefName:String, alertDefModel:String, alertDefDesc:String, alertDef:String)
		{
