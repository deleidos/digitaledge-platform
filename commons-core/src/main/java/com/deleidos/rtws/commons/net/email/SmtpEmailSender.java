...
public class SmtpEmailSender implements EmailSenderInterface {
	...
	private SmtpEmailConfiguration config;
		
	public void configure(EmailConfiguration emailConfiguration) {
		config = (SmtpEmailConfiguration)emailConfiguration;
	}
	...
	public boolean sendEmail(String from, String[] recipients, String subject, String msgBody) {
		...
		try {
			...
			if(isAuthRequired()){
				...
				String userPasswd = properties.getProperty("mail.password");
				if(isTlsRequired())
					transport.connect(emailHost, user, userPasswd);
				else{
					int port = Integer.parseInt(properties.getProperty("mail.smtp.port"));
					transport.connect(emailHost, port, user, userPasswd);
				}
	...
	public void setAuthRequired(boolean authRequired) {
		config.setIsAuthRequired(authRequired);
	}


	public boolean isTlsRequired() {
		return config.isTlsRequired();
	}


	public void setTlsRequired(boolean tlsRequired) {
		config.setIsTlsRequired(tlsRequired);
	}
