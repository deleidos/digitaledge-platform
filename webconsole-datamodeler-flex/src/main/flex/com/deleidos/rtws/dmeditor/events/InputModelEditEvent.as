...
package com.deleidos.rtws.dmeditor.events
{
	...
	public class InputModelEditEvent extends Event
	{
		...
		public static const MODEL_FIELD_DELETED    :String = EDIT_KEY + ".model.fieldDeleted";
		public static const MODEL_UPDATE_FIELD     :String = EDIT_KEY + ".model.updateField";
		public static const MODEL_FIELD_UPDATED    :String = EDIT_KEY + ".model.fieldUpdated";
		...
		public static const MODEL_MAP_GET_ARRAY    :String = EDIT_KEY + ".model.mapGetArray";
		...
		public static const MODEL_MAP_CHANGED      :String = EDIT_KEY + ".model.changed";
		
		public static const MODEL_DEL_DATASRC_FIELD_CHECK :String = EDIT_KEY + "model.deleteDataSrcCheck";
		public static const MODEL_DEL_DATASRC_FIELD_DELETE:String = EDIT_KEY + ".model.deleteDataSourceField";
