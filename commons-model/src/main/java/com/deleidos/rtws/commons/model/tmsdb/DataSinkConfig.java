...
public class DataSinkConfig {
	...
	/** The uses block storage. */
	private boolean usesBlockStorage;
	...
	/**
	 * Checks if is uses block storage.
	 *
	 * @return true, if is uses block storage
	 */
	public boolean isUsesBlockStorage() {
		return usesBlockStorage;
	}

	/**
	 * Sets the uses block storage.
	 *
	 * @param usesBlockStorage the new uses block storage
	 */
	public void setUsesBlockStorage(boolean usesBlockStorage) {
		this.usesBlockStorage = usesBlockStorage;
	}

	/**
	 * Sets the uses block storage.
	 *
	 * @param choice the new uses block storage
	 */
	public void setUsesBlockStorage(char choice) {
		switch (choice) {
		case 'Y': case 'y':
			this.usesBlockStorage = true;
			break;
		default:
			this.usesBlockStorage = false;
			break;
		}
