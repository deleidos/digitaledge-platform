...
//	import flash.events.Event;
	...
	public class ApplicationCommandEvent extends Event
	{
		...
		public static const USER_DATA			:String = COMMAND_KEY + ".userData";
		public static const USER_DATA_SUCCESS	:String = COMMAND_KEY + ".userDataSucess";
		public static const USER_DATA_ERROR		:String = COMMAND_KEY + ".userDataError";
