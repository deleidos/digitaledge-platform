...
public class PodTest {
	...
	@Test
	public void marshal() throws JsonGenerationException, JsonMappingException, IOException {
		ObjectMapper mapper = new ObjectMapper();
		mapper.setVisibility(JsonMethod.FIELD, Visibility.ANY);
		mapper.setSerializationInclusion(Inclusion.NON_DEFAULT);

		Pod pod = new Pod();
		pod.setId("elasticsearch1");

		Container container = new Container();
		container.setImage("digitaledge/delastic:rtws-nightly.2015-02-02_1234");
		...
		pod.withLabel("digitaledge.domain", "test.domain");
		pod.withLabel("digitaledge.fqdn", "ingest-all-node1test.domain");
		pod.withLabel("RTWS_BYPASS", "");

		System.out.println(mapper.writerWithDefaultPrettyPrinter().writeValueAsString(pod));
	}

	@Test
	public void test() {
		int memory = 3840;
		long memoryInBytes = Long.valueOf(memory) * 1000000l;
