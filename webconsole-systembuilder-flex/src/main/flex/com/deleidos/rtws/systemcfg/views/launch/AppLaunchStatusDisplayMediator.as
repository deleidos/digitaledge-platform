 ...
 */
package com.deleidos.rtws.systemcfg.views.launch
{
	...
	import com.deleidos.rtws.systemcfg.views.launch.AppLaunchStatusDisplay;
		...
		* ============================================== */
		...
		private function onStartupBatchStatusEvent(event:BatchOperationStatusEvent):void
		{
			...
			if(OperationStatusEvent.SUB_TYPE_SUCCESS == event.subType)
			{
				...
				statusMsg = new StatusMessage(StatusType.SUCCESS);
			}
			...
			{
				statusMsg = new StatusMessage(StatusType.PROGRESS);
			}
