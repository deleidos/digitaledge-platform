...
import com.deleidos.rtws.transport.model.Encoding;

public class SimpleUDPMessageProcessor implements Runnable {

	private static final Logger log = Logger.getLogger(SimpleUDPMessageProcessor.class);
	...
	public SimpleUDPMessageProcessor(DatagramPacket packet, AbstractTransportService reciever) {
		this.packet = packet;
		this.reciever = reciever;
		if ( reciever != null && reciever instanceof UDPTransportService )
			encoding = ((UDPTransportService)reciever).getEncoding();
	}
