...
package com.deleidos.rtws.systemcfg.events
{
	...
	{
		public static const KEY:String = getQualifiedClassName(ModelServiceEvent);
		
		public static const LOAD_MODEL_DIR   	:String = KEY + ".loadModelDir";
		public static const LOAD_TENANT_SYSTEMS :String = KEY + ".loadTenantSystems";
		public static const LOAD_DATA_MODEL     :String = KEY + ".loadDataModel";
