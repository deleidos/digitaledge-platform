...
/**
 * Matcher that evaluates whether a given value is strictly greater than the configured value;
 */
public class IsGreater implements Matcher {

	private static Parser parser = Parser.compile("\\s*>\\s*(\\l)\\s*");
	
	private Object criteria;
	
	public IsGreater(Object criteria) {
	...
	public static IsGreater valueOf(String expression) {
		return new IsGreater(parser.parse(expression).getTermAsLiteral(0));
	}
