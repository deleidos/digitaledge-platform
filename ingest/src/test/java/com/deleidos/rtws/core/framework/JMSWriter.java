...
public class JMSWriter {
	...
	private static String subject = "com.deleidos.rtws.test";
	...
	public static void main(String[] args) {
		...
		try {
            ...
            // Send the desired  number of messages, and close the session upon completion.
	...
	private static void sendLoop(Session session, MessageProducer producer) throws Exception 
	{
        String text = "{vocabulary:\"spam\", text:\"test message 1\", source:\"activemq\", props:\"persistent\"}\n";
        text = text + text + text + text + text + text + text + text + text;
        for(int i=1;i<=3;i++){
        	 TextMessage message = session.createTextMessage(text);
             message.setStringProperty("Data.Format", "json");
             //message.setStringProperty("Data.Workflow", "default");
