...
import com.deleidos.rtws.commons.net.listener.process.TomcatProcess;

public class S2iExplorerMonitor extends ProcessMonitor {
	
	TomcatProcess process = TomcatProcess.newInstance();

	public S2iExplorerMonitor(String name) {
		super(name);
		/*
	...
	protected void monitor() {
		try {
			...
			case Running:
				...
				break;
			case Stopped:
				addError("S2i Explorer is not running.");
				break;
			case Unknown:
			default:
				addError("S2i Explorer's status is currently unknown.");
				break;
			}
