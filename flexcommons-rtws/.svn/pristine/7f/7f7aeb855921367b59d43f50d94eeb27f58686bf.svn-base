	...
	*/
	...
	public class StringUtils {
		...
		*/
		...
		/**
		 *	Determines whether the specified string is null or contains only whitespace characters.
		 *  [Note:] Addition to original library.
		 *
		 *	@param p_string The string to check
		 *
		 *	@returns true if p_string is null, empty, or only whitespace characters; false otherwise.
		 *
		 * 	@langversion ActionScript 3.0
		 *	@playerversion Flash 9.0
		 *	@tiptext
		 */
		public static function isBlank(p_string:String):Boolean {
			if (p_string == null) { return true; }
			return (p_string.search(/\S/) == -1);
		}
		
		/**
		 *	Determines whether the specified string is not null and contains at least
		 *  one non-whitespace characters.
		 *  [Note:] Addition to original library.
		 *
		 *	@param p_string The string to check
		 *
		 *	@returns true if p_string is not null and contains at least one non-whitespace character; false otherwise.
		 *
		 * 	@langversion ActionScript 3.0
		 *	@playerversion Flash 9.0
		 *	@tiptext
		 */
		public static function isNotBlank(p_string:String):Boolean {
			return !isBlank(p_string);
		}
