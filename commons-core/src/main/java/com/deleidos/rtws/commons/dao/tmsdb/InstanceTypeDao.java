...
public class InstanceTypeDao {
	...
	public Collection<InstanceType> getInstanceTypes(){
		Collection<InstanceType> types = session.executeMultiRowQuery("select * from instance_types order by num_cores asc", new DefaultStatementHandler(), new InstanceTypeBuilder());
