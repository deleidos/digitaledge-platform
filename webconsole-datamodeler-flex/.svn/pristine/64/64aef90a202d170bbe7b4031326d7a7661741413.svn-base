...
package com.deleidos.rtws.dmeditor.events
{
	...
	public class ModelServiceEvent extends Event
	{
		...
		public static const DELETE_MODEL       :String = MODELSRV_KEY + ".deleteModel";
		...
		public static const DM_DELETION_CHECK  :String = MODELSRV_KEY + ".dataModelDeleteCheck";
		
		public static const DM_USAGE_CHECK         :String = MODELSRV_KEY + ".dataModelUsageCheck";
		public static const RESET_DM_USAGE_POLLING :String = MODELSRV_KEY + ".resetDmUsagePolling";
		public static const START_DM_USAGE_POLLING :String = MODELSRV_KEY + ".startDmUsagePolling";
		public static const DM_USAGE_UPDATED       :String = MODELSRV_KEY + ".dmUsageUpdated";
		
		public static const MODEL_WIZARD_START 	   :String = MODELSRV_KEY + ".modelWizardStart";
		public static const MODEL_WIZARD_STARTED   :String = MODELSRV_KEY + ".modelWizardStarted";
		public static const MODEL_WIZARD_POLL      :String = MODELSRV_KEY + ".modelWizardPoll";
		public static const MODEL_WIZARD_DONE      :String = MODELSRV_KEY + ".modelWizardDone";
		public static const MODEL_WIZARD_LOAD      :String = MODELSRV_KEY + ".modelWizardLoad";
		public static const MODEL_WIZARD_LOADED    :String = MODELSRV_KEY + ".modelWizardLoaded";
		public static const MODEL_WIZARD_GET_DETAIL:String = MODELSRV_KEY + ".modelWizardGetDetail";
		public static const MODEL_WIZARD_DETAIL_GOT:String = MODELSRV_KEY + ".modelWizardDetailGot";
