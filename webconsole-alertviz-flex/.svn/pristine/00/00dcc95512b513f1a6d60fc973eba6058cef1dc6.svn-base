package org.un.cava.birdeye.ravis.graphLayout.visual.events
{
    ...
    public class VisualEdgeEvent extends Event
    {
		...
		public static const DATA_UPDATED:String = "edgeDataUpdated";
        
        public var edge:IVisualEdge;
        public var ctrlKey:Boolean;
        
        public function VisualEdgeEvent(type:String, edge:IVisualEdge, ctrlKey:Boolean=false, bubbles:Boolean=false, cancelable:Boolean=false)
        {
