 ...
 */
package com.deleidos.rtws.boot.app.beans;
...
/**
 * Attacher definition configuration.
 * @author LUCECU
 *
 */
public class AttacherDefinition {
	 ...
	 * Default constructor.
	 */
	public AttacherDefinition(){
		
	}
	
	/**
	 * Initialize the service and storage interfaces
	 * to the common service and storage interface values
	 * for the system.
	 */
	public void intializeInterfaces() {
		this.serviceInterface = InterfaceConfig.getInstance().getServiceInterface();
		this.storageInterface = InterfaceConfig.getInstance().getStorageInterface();
	}
