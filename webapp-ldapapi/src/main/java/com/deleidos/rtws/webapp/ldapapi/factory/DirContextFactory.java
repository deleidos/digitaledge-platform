 ...
 */
package com.deleidos.rtws.webapp.ldapapi.factory;
...
public class DirContextFactory {
	...
	public static DirContext getBaseDirContext(String privateIpAddress) throws NamingException {
		
		RtwsConfig config = RtwsConfig.getInstance();

		String providerUrl = buildUrl(privateIpAddress);
		...
		url.append(providerUrl).append('/').append(searchBaseDn);
	...
	private static String buildUrl(String privateIpAddress) {
		
		StringBuilder sb = new StringBuilder();
		sb.append("ldap://").append(privateIpAddress).append(":10389");
