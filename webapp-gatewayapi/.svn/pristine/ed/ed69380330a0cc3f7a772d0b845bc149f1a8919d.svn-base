...
public class Node {
	...
	private Map<Volume,Float> volumes;
	...
	public String getPersistentIpAddress() {
		return this.persistentIpAddress;
	}
	...
	public boolean isEbsRootDeviceType() {
		return "ebs".equalsIgnoreCase(rootDeviceType);
	}
	
	public Map<Volume, Float> getVolumes() {
		return volumes;
	}

	public void setVolumes(Map<Volume, Float> volumes) {
