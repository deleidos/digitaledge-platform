 ...
 */
package com.deleidos.rtws.webapp.register.service.cloud;
...
public class AwsConnectionFactory {
	...
	/** Endpoint to communicate with AWS EC2. */ 
	...
	public AmazonEC2Client getAmazonEC2Client() {
		...
		try {
			connectionTimeout = Integer.parseInt(PropertiesFile.getInstance().getString("ec2.client.config.connection.timeout","90")) * 1000;
			socketTimeout = Integer.parseInt(PropertiesFile.getInstance().getString("ec2.client.config.socket.timeout","90")) * 1000;
	...
	/**
	 * Creates a new Amazon Route53 Client.
	 */
	public AmazonRoute53Client getAmazonRoute53Client() {
		return new AmazonRoute53Client(getCredentials());
	}
	
	public AmazonRoute53Client getAmazonRoute53Client(String accessKey, String secretKey) {
		return new AmazonRoute53Client(new BasicAWSCredentials(accessKey, secretKey));
	}
