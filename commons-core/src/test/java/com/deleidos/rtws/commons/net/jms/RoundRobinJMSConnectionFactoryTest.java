...
@Ignore
public class RoundRobinJMSConnectionFactoryTest extends TestCase {

	@Test
	public void testConnection() throws JMSException, InterruptedException {
		System.out.println("1");
		RoundRobinJMSConnectionFactory cf = new RoundRobinJMSConnectionFactory();
		cf.setBrokerURL("tcp://localhost:61616");
		cf.setUserName("system");
		cf.setPassword("redacted");
		System.out.println("2");
		Connection connection = cf.createConnection();
		System.out.println("3");
		Session session = connection.createSession(false, Session.AUTO_ACKNOWLEDGE);
		System.out.println("4");
		Destination dest = session.createQueue("com.deleidos.rtws.mongodb");
