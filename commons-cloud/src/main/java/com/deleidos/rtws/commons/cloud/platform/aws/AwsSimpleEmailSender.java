...
public class AwsSimpleEmailSender implements EmailSenderInterface {
	...
	private AwsEmailConfiguration config;

	/**
	 * Configure the AwsSimpleEmailSender
	 * 
	 * @param emailConfiguration
	 *            configuration to use for the sender
	 */
	public void configure(EmailConfiguration emailConfiguration) {
		this.config = (AwsEmailConfiguration) emailConfiguration;
	}
	...
	/*public void configure(AwsConnectionFactory awsConnectionFactory) {
		if(config == null) {
			config = new AwsEmailConfiguration();
		}
		
		config.setAwsConnectionFactory(awsConnectionFactory);
	}*/
	...
	public boolean sendEmail(String from, String[] recipients, String subject,
		...
		AmazonSimpleEmailServiceClient client = config.getAwsConnectionFactory().getAmazonSimpleEmailServiceClient();
		...
		if (msgBody.contains("<html")) {
			...
			htmlContent.setData(msgBody);
			body.setHtml(htmlContent);
		} else {
			Content bodyContent = new Content(msgBody);
