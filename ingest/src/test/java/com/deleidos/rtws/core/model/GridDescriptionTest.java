...
public class GridDescriptionTest {
	...
	public void testConstructor() {
		GridDescription obj1 = new GridDescription();
		assertNotNull(obj1);
	}
	...
	public void testGettersAndSetters() {
		...
		GridDescription beanObj = new GridDescription();
		...
		// Test Class
		beanTester.testClass(GridDescription.class);
