...
public class DataSourceDefinition {
	...
	public static String DEFAULT_DATA_SOURCE_ORGIN;
	...
	public void setSourceSystemVersion(String sourceSystemVersion) {
		this.assetVersion = sourceSystemVersion;
	}
	...
	public void addToProperties(Properties properties) {
		if(sigad != null) {
			properties.put("DataSource.SIGAD", sigad);
		}
		if(pddg != null) {
			properties.put("DataSource.PDDG", pddg);
		}
		if(ssd != null) {
			properties.put("DataSource.SSD", ssd);
		}
		if(systemName != null) {
			properties.put("DataSource.System", systemName);
		}
		if(assetName != null) {
			properties.put("DataSource.Asset", assetName);
		}
		if(assetVersion != null) {
			properties.put("DataSource.Version", assetVersion);
		}
	}
