 ...
 */
package com.deleidos.rtws.systemcfg.composer;
...
public interface DefinitionComposer extends Initializable {
	/**
	 * Additional write method, write configuration that composer created.
	 * 
	...
	/**
	 * Loads defaults from database or from templates based on the version.
	 * 
	 * @param version String value
	 * @param config {@link SystemConfig}
	 * @param systemContext {@link SystemContext}
	 * @param properties {@link RtwsProperties}
