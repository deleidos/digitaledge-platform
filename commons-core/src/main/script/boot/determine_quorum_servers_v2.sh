...
do
	RTWS_ZOOKEEPER_INSTANCE_TOTAL="$(java -cp /usr/local/rtws/commons-core/lib/deleidos-rtws-commons-core.jar: com.deleidos.rtws.commons.util.QueryJmxByProcessGroup "master.$RTWS_DOMAIN:1099" "rtws.deleidos.com:type=ProcessGroup,group=zookeeper" "ActiveProcessCount" | tr -d [:alpha:] | tr -d [:space:])"
