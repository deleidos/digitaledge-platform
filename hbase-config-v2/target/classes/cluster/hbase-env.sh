...
export HBASE_HEAPSIZE=RTWS_HBASE_HEAPSIZE

# Extra Java runtime options.
# Below are what we set by default.  May only work with SUN JVM.
# For more on why as well as other possible settings,
# see http://wiki.apache.org/hadoop/PerformanceTuning
export HBASE_OPTS="-XX:+UseConcMarkSweepGC -XX:+CMSIncrementalMode -Dnetworkaddress.cache.negative.ttl=0 -Djava.net.preferIPv4Stack=true"
...
export HBASE_MASTER_OPTS="$HBASE_MASTER_OPTS $HBASE_JMX_BASE -Dcom.sun.management.jmxremote.port=10101 -DRTWS_DOMAIN=$RTWS_DOMAIN -DRTWS_ZOOKEEPER_QUORUM_SERVERS=$RTWS_ZOOKEEPER_QUORUM_SERVERS"
export HBASE_REGIONSERVER_OPTS="$HBASE_REGIONSERVER_OPTS $HBASE_JMX_BASE -Dcom.sun.management.jmxremote.port=10102 -DRTWS_DOMAIN=$RTWS_DOMAIN -DRTWS_ZOOKEEPER_QUORUM_SERVERS=$RTWS_ZOOKEEPER_QUORUM_SERVERS"
export HBASE_THRIFT_OPTS="$HBASE_THRIFT_OPTS $HBASE_JMX_BASE -DRTWS_DOMAIN=$RTWS_DOMAIN -DRTWS_ZOOKEEPER_QUORUM_SERVERS=$RTWS_ZOOKEEPER_QUORUM_SERVERS -Dcom.sun.management.jmxremote.port=10103"
