...
public final class UserDataUtil {
	...
	public static String getSwVersion() {
		return userData.getString(UserDataProperties.RTWS_SW_VERSION);
	}
	
	public static String getIaasRegion() {
		return userData.getString(UserDataProperties.RTWS_IAAS_REGION);
	}
