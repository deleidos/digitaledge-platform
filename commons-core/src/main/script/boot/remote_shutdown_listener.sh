...
java -DRTWS_ROOT_LOG_LEVEL=$RTWS_ROOT_LOG_LEVEL -DRTWS_APP_LOG_LEVEL=$RTWS_APP_LOG_LEVEL -Xms56M -Xmx56M -cp /usr/local/rtws/commons-core/lib/*: com.deleidos.rtws.commons.net.shutdown.Shutdown &
