...
package com.deleidos.rtws.alertcontroller.views
{
	...
	import com.deleidos.rtws.alertcontroller.models.CurrentDataModel;
	import com.deleidos.rtws.alertcontroller.views.popups.BrowseDataModelPopUpView;
	import com.deleidos.rtws.alertcontroller.views.popups.CreateAlertDefinitionHelpPopUpView;
	import com.deleidos.rtws.alertcontroller.views.popups.CreateAlertValueSuggestionPopUpView;
	import com.deleidos.rtws.alertcontroller.views.popups.FormatHelpPopUpView;
	...
	public class CreateAlertDefinitionViewMediator extends Mediator
	{
		[Inject]
		public var view:CreateAlertDefinitionView;
		
		[Inject]
		public var dataModel:CurrentDataModel;
		
		public override function onRegister():void 
		{
			
			addViewListener(ManageViewsEvent.OPEN_ALERT_DEF_HELP, handleHelpButton);
			addViewListener(ManageViewsEvent.OPEN_ALERT_DEF_FORMAT, handleFormatHelpButton);
			addViewListener(ManageViewsEvent.OPEN_ALERT_DEF_BROWSE, handleBrowseButton);
			addViewListener(ManageViewsEvent.CLOSE_CREATE_ALERT_DEFINITION, dispatch);
			addViewListener(ManageViewsEvent.OPEN_ALERT_VALUE_SUGGESTION, handleAlertvalueSuggestionPopup);

			addViewListener(AlertCriteriaCommandEvent.ADD_DEF, handleAddDef);
			addViewListener(AlertCriteriaCommandEvent.BROWSE_CANCEL, dispatch);

			addViewListener(ValidationResultEvent.VALID, dispatch);

			addContextListener(AlertCriteriaCommandEvent.SEND_DEF, handleSendDef);
			addContextListener(AlertCriteriaCommandEvent.SEND_PATH, handleSendPath);
			addContextListener(AlertCriteriaCommandEvent.RETURN_VAL, handleReturnVal);
//			addContextListener(AlertCriteriaCommandEvent.BROWSE_CANCEL, handleBrowseCancel);
			addContextListener(AlertCriteriaCommandEvent.IGNORE, handleIgnore);
//			addContextListener(AlertCriteriaCommandEvent.SEND_MODEL, handleSendModel);
...
//			view.cancelButton.removeEventListener(MouseEvent.CLICK, handleHelpButton);
		...
		{
			view.handleSendPath(event.parameters);
		}
		
		protected function handleAlertvalueSuggestionPopup(event:ManageViewsEvent):void
		{
		...
		protected function handleCancelButton(event:ManageViewsEvent):void 
		{
//			closeView();
		}
...
//			eventMap.unmapListener(eventDispatcher, AlertCriteriaCommandEvent.SEND_MODEL, handleSendModel);
			view.handleSendDef(event.parameters);
		}
		 ...
		 */
		protected function handleHelpButton(event:ManageViewsEvent):void
		{
		 ...
		 */
		protected function handleBrowseButton(event:ManageViewsEvent):void
		{
			dataModel.setCurrentDataModel(view.modelLabel.text);
...
//			dispatch(new AlertCriteriaCommandEvent(AlertCriteriaCommandEvent.SEND_MODEL, view.modelLabel.text));
		}
		...
		{
			view.handlePopupReturnValues(event.parameters);
		}
		 ...
		 */
		protected function handleFormatHelpButton(event:ManageViewsEvent):void
		{
		...
		protected function handleSendModel(event:AlertCriteriaCommandEvent):void
		{
			...
			view.modelLabel.text = event.parameters.toString();
