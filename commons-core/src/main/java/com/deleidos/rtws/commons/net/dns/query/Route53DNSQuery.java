 ...
 */
package com.deleidos.rtws.commons.net.dns.query;
...
import com.deleidos.rtws.commons.net.dns.exception.QueryException;
import com.deleidos.rtws.commons.net.dns.query.dao.ChangeBatch;
import com.deleidos.rtws.commons.net.dns.query.dao.ChangeInfo;
import com.deleidos.rtws.commons.net.dns.query.dao.ChangeResourceRecordSetsResponse;
import com.deleidos.rtws.commons.net.dns.query.dao.ChangeResourceRequest;
import com.deleidos.rtws.commons.net.dns.query.dao.ErrorResponse;
import com.deleidos.rtws.commons.net.dns.query.dao.GetChangeResponse;
import com.deleidos.rtws.commons.net.dns.query.dao.ListResourceRecordSetsResponse;
import com.deleidos.rtws.commons.net.dns.query.dao.ResourceRecord;
	...
	public ChangeInfo queryChange(String changeId, String queryUrl) throws QueryException, DNSException {
		...
		try {
			...
			if (code == HttpURLConnection.HTTP_OK) {
				...
				com.deleidos.rtws.commons.net.dns.query.dao.Error error = errorResponse.getError();
