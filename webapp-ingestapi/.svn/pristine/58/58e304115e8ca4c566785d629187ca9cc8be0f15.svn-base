...
import com.deleidos.rtws.webapp.ingestapi.model.EnrichmentDef;

/**
 * JUnit test for class.
 */
public class EnrichmentDefTest {
	...
	public void testConstructor() {
		EnrichmentDef obj1 = new EnrichmentDef();
		assertNotNull(obj1);
	}
	...
	public void testGettersAndSetters() {
		...
		EnrichmentDef beanObj = new EnrichmentDef();
		...
		// Test Class
		beanTester.testClass(EnrichmentDef.class);
