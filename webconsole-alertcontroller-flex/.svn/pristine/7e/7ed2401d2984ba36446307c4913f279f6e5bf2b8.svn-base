...
package com.deleidos.rtws.alertcontroller.views
{
	...
	public class AlertControllerMediator extends Mediator
	{
		[Inject] public var view:AlertController;
		
		public function AlertControllerMediator()
		{
			super();
		}
		...
		{
			if(event != null && event.isComplete() && AlertController.STARTUP_TRACKING_TOKEN === event.trackingToken)
			{
