...
package com.deleidos.rtws.dmeditor.models
{
	...
	public class InputModelUtilities
	{
									...
									params:Object):void
		{
			...
			var arrayReferences:int = (inputModelPath == null) ? 0 : (inputModelPath.split("[").length - 1);
