...
package com.deleidos.rtws.tablemgr.view
{
	...
	public class TableMgrMediator extends Mediator
	{
		[Inject]
		public var view:TableManager;
		
		private var _isCreationComplete:Boolean = false;
		private var _tmpViewState:String = null;
		
		public function TableMgrMediator()
		{
			super();
		}
		
		// Safe to attach these listeners here ... context is initialized onCreationComplete of Application
		override public function onRegister():void
		{
			...
			addViewListener(TableBatchDataEvent.IMPORT_STATUS, dispatch);
		}
		...
		override protected function onCreationComplete(e:Event):void
		{
			...
			if(view != null)
			{
				if(_tmpViewState != null)
				{
					view.currentState = _tmpViewState;
					_tmpViewState = null;
				}
			}
		...
		* ============================================== */
		...
		private function onStartupBatchStatusEvent(event:BatchOperationStatusEvent):void
		{
			...
			if(view != null)
			{
				view.currentState = newViewState;
			}
			else
			{
				_tmpViewState = newViewState;
			}
		}
	}
}