...
import static com.deleidos.rtws.commons.util.regex.PatternUtils.removeCapturingCroups;
...
import com.deleidos.rtws.commons.util.expression.primitive.Matchers;
...
public class Literal {
	...
	private static Logger logger = Logger.getLogger(Literal.class);
	...
	public static Object valueOf(String value) {
		if (value == null) {
			...
			try {
				...
				logger.error("Literal Long value " + value + " failed to parse", nfe);
				throw nfe;
			}
