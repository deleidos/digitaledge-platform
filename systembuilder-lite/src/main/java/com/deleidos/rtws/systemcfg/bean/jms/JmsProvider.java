 ...
 */
package com.deleidos.rtws.systemcfg.bean.jms;
...
public class JmsProvider{
	 ...
	 */
	public JmsProvider(CursorType queuePolicy, CursorType subscriberPolicy){
	...
	public String toString(){
		String config = String.format("Queue Policy:  %s, Subsciber Policy:  %s", 
										this.queuePolicy, this.subscriberPolicy);
